    ...
    try {
      ...
      if (
        ...
        if (Array.isArray(friendsuggestionsList)) {
          ...
          console.error("Unexpected friends format:", friendsuggestionsList);
          setF_requests([]);
        }
      } else {
        console.error("Unexpected response format:", response.data);
      ...
      <header>
        <nav class="nav">
          ...
          <div id="buttons">
            ...
            <button class="button" type="primary" onClick={showDrawer}>
              Friends
            </button>
          </div>
          <Drawer
            ...
            <div className="friends">
              ...
              {currentlySelected === "Friends_req" &&
                f_requests.map((friend, index) => (
                  <FriendReqCard key={index} friend={friend} />
                ))}

              {currentlySelected === "add_friend" &&
                f_suggestions.map((friend, index) => (
                  <FriendSugCard key={index} friend={friend} />
                ))}
            </div>
          </Drawer>
        </nav>
